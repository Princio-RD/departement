...
<div class="app-wrap">
  ...
  <aside class="sidebar">
    ...
    <ul class="sidebar-nav">
      ...
      <li>
        <a href="<?= base_url('admin/validation-rh') ?>">
          <i class="bi bi-inbox"></i> Toutes les demandes
          <?php $pending = $stats['demandes_en_attente'] ?? 0; if ($pending > 0): ?>
          <span class="nav-badge alert"><?= $pending ?></span>
          <?php endif; ?>
        </a>
      </li>
  ...
  <div class="main">
    <div class="topbar">
      ...
      <div class="topbar-actions">
        <a href="<?= base_url('admin/create-employe') ?>" class="btn-forest" style="padding:7px 14px;font-size:.82rem"><i class="bi bi-person-plus"></i> Ajouter un employé</a>
      </div>
    </div>
    ...
    <div class="content">
      ...
      <div class="metrics">
        ...
        <div class="metric">
          ...
          <div class="metric-val"><?= number_format($stats['demandes_en_attente'] ?? 0) ?></div>
      ...
      <div style="display:grid;grid-template-columns:1fr 320px;gap:1.5rem;align-items:start">
        ...
        <div class="data-card" style="margin:0">
          <div class="data-card-head">
            ...
            <a href="<?= base_url('admin/validation-rh') ?>" style="font-size:.8rem;color:var(--forest);text-decoration:none">Tout voir →</a>
          </div>
          <table class="tbl">
            <thead>
            ...
            <tbody>
              <?php if (!empty($lastDemandes)): ?>
                ...
                <?php endforeach; ?>
              <?php else: ?>
                <tr><td colspan="4" style="text-align:center;padding:1rem;color:var(--muted)">Aucune demande récente</td></tr>
              <?php endif; ?>
            </tbody>
          </table>
        </div>
