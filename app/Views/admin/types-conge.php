        ...
        <div class="data-card">
          ...
          <table class="tbl">
            ...
            <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="action-btns">
                        <a class="btn-sm btn-edit" href="<?= base_url('admin/types-conge/' . (int)($type['id'] ?? 0) . '/edit') ?>"><i class="bi bi-pencil"></i> Éditer</a>
                      </div>
                    </td>
                  </tr>
                <?php endforeach; ?>
              <?php else: ?>
                <tr>
                  <td colspan="4" style="text-align:center;padding:1rem;color:var(--muted)">Aucun type configuré</td>
                </tr>
              <?php endif; ?>
            </tbody>
          </table>
