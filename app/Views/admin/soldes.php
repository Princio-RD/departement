        ...
        <div class="data-card">
          ...
          <table class="tbl">
            ...
            <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="action-btns">
                        <a class="btn-sm btn-edit" href="<?= base_url('admin/soldes/' . (int)($solde['id'] ?? 0) . '/edit') ?>"><i class="bi bi-pencil"></i> Éditer</a>
                      </div>
                    </td>
                  </tr>
                <?php endforeach; ?>
              <?php else: ?>
                <tr>
                  <td colspan="6" style="text-align:center;padding:1rem;color:var(--muted)">Aucun solde pour cette année</td>
                </tr>
              <?php endif; ?>
            </tbody>
          </table>
