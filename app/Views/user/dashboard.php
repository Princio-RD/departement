...
<div class="app-wrap">
  ...
  <aside class="sidebar">
    ...
    <ul class="sidebar-nav" style="margin-top:1rem">
      <li><a href="/user/dashboard" class="active"><i class="bi bi-grid-1x2"></i> Tableau de bord</a></li>
  ...
  <div class="main">
    <div class="topbar">
      ...
      <div class="topbar-actions">
        <a href="/user/conges/nouveau" class="btn-forest" style="padding:7px 14px;font-size:.82rem">
    ...
    <div class="content">
      ...
      <div class="metrics">
        ...
        <div class="metric">
          <div class="metric-top"><div class="metric-icon mi-blue"><i class="bi bi-x-octagon"></i></div></div>
      ...
      <div style="display:grid;grid-template-columns:1fr 360px;gap:1.5rem;align-items:start">
        ...
        <div class="data-card" style="margin:0">
          <div class="data-card-head">
            ...
            <a href="/user/conges" style="font-size:.8rem;color:var(--forest);text-decoration:none">Tout voir →</a>
          </div>
          <table class="tbl">
            <thead>
            ...
            <tbody>
              <?php if (empty($lastDemandes)): ?>
                <tr><td colspan="4" class="td-muted" style="padding:1rem">Aucune demande.</td></tr>
              <?php else: ?>
        ...
        <div class="data-card" style="margin:0">
          <div class="data-card-head"><h3><i class="bi bi-piggy-bank" style="color:var(--forest);margin-right:5px"></i>Mes soldes — <?= $annee ?></h3></div>
