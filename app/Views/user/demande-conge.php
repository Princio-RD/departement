  ...
  <div class="app-wrap">
    ...
    <aside class="sidebar">
      ...
      <ul class="sidebar-nav" style="margin-top:1rem">
        ...
        <li><a href="<?= base_url('user/conges/nouveau') ?>" class="active"><i class="bi bi-plus-circle"></i> Nouvelle demande</a></li>
      ...
      <div class="topbar">
        <div>
          ...
          <div class="topbar-breadcrumb">
            <a href="<?= base_url('user/dashboard') ?>">Accueil</a>
        ...
        <div style="display:grid;grid-template-columns:1fr 300px;gap:1.5rem;align-items:start" class="form-layout">
          ...
          <div>
            <div class="form-section">
              ...
              <form method="post" action="<?= base_url('user/conges') ?>" novalidate>
                <?= csrf_field() ?>
                ...
                <div class="form-actions">
                  ...
                  <a href="<?= base_url('user/dashboard') ?>" class="btn-secondary"><i class="bi bi-x"></i> Annuler</a>
                </div>
              </form>
            </div>
          </div>
